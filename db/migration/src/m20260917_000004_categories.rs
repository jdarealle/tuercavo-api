...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager.create_table(Table::create().table(Categories::Table)
            ...
            .col(ColumnDef::new(Categories::Name).string_len(150).not_null())
            ...
            .check(("ck_categories_name", Expr::cust(r#"char_length(name) BETWEEN 1 AND 150 AND name = btrim(name) AND name !~ '[[:cntrl:]]'"#)))
        ...
        manager
            .create_index(
                Index::create()
                    ...
                    .col(Func::lower(Expr::col(Categories::Name)))
                    .unique()
                    .to_owned(),
            )
            .await?;
