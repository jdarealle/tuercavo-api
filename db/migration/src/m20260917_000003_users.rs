...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager.create_table(Table::create().table(Users::Table)
            ...
            .col(ColumnDef::new(Users::Email).string_len(254))
            .col(ColumnDef::new(Users::FullName).string_len(150))
            ...
            .foreign_key(ForeignKey::create().name("fk_users_department").from(Users::Table, Users::DepartmentId).to(Departments::Table, Departments::Id).on_delete(ForeignKeyAction::Restrict))
